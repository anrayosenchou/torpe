...
var lyricsData = [
  ...
  { text: "Lo que mi alma vacía", time: 4 },
  { text: "Quería sentir", time: 8 },
  { text: "Eres lo que tanto esperaba", time: 13 },
  { text: "Lo que en sueños buscaba", time: 17 },
  { text: "Y que en ti descubrí", time: 20 },
  { text: "Tu has llegado a encender", time: 26 },
  { text: "Cada parte de mi alma", time: 30 },
  { text: "Cada espacio de mi ser", time: 34 },
  { text: "Ya no tengo corazon", time: 37 },
  { text: "Ni ojos para nadie", time: 40 },
